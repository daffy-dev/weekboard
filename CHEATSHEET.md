...
| Accent color / artwork / ASCII character | `"accent"` (hex) in config; `wb ascii --use shuriken` or `wb ascii yourphoto.jpg`; `wb art yourphoto.jpg` or `wb art --generate "..."` for the background photo |
